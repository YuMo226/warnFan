	...
	; Compiler options:
	;
	; -owarmFan.cof -mwarmFan.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel main.p1 Key.p1 Task.p1 StepMotor.p1 \
	; PWM.p1 FallDown.p1 ptc_driver.p1 Display.p1 \
	; D:\Homework\laptop\Homework\嵌入式\warmFan_finish\CMS_CheckTouch_PT_79F72x_V1.01.lpp \
	; --chip=79F726 -P --runtime=default, \
